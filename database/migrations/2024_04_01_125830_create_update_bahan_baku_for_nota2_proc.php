...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `update_bahan_baku_for_nota2`(IN `nota` VARCHAR(20))
BEGIN
    ...
    DECLARE bahan_baku_quantity FLOAT;
        ...
        DECLARE cur CURSOR FOR 
            ...
            FROM resep r
            JOIN detail_transaksi dt ON r.id_produk = dt.id_produk
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS update_bahan_baku_for_nota2");
    }
};
