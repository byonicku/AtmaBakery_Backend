...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("CREATE PROCEDURE `get_all_laporan_transaksi_penitip2`(IN `month_param` INT, IN `year_param` INT)
BEGIN
        SELECT
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS get_all_laporan_transaksi_penitip2");
    }
};
